    ...
    return (
        <section className="about-container">
            <div className="about">
                ...
                <p className="about-text">I am Jeremy, a highly skilled web developer with a passion for creative problem solving. With a background in art and a strong customer service orientation, I bring a unique perspective to my development projects, enabling me to overcome challenges with innovative solutions.
